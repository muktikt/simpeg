                    ...
                    @if ($bisaKelola)
                        <td>
                            <div class="row-actions">
                                ...
                                <form action="{{ route('prestasi.destroy', $p['id']) }}" method="POST" onsubmit="return confirmSubmit(event, 'Hapus data prestasi ini?', 'Konfirmasi Hapus', 'danger', 'Ya, Hapus');" style="margin:0;">
                                    @csrf
                                    @method('DELETE')
