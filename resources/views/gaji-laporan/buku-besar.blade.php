        ...
        <tbody>
            @forelse ($data as $d)
                <tr>
                    ...
                    <td>Rp {{ number_format($d['total_pendapatan'] ?? ($d['gaji_pokok'] ?? 0), 0, ',', '.') }}</td>
                    <td>Rp {{ number_format($d['total_potongan'] ?? 0, 0, ',', '.') }}</td>
                    <td><strong>Rp {{ number_format($d['gaji_bersih'] ?? ($d['total_terima'] ?? 0), 0, ',', '.') }}</strong></td>
                </tr>
            @empty
