...
@section('title', 'Laporan Potongan BPJS')

@section('content')
<div class="page-head">
    <div class="breadcrumb">Home / Laporan / Laporan Potongan BPJS</div>
    <h1>LAPORAN POTONGAN BPJS</h1>
</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th>NIK</th>
                <th>Nama Pegawai</th>
                <th style="text-align:right;">Potongan BPJS</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td style="text-align:right; font-weight:600;">Rp {{ number_format($item['pot_bpjs'] ?? 0, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="4">
                        <div class="table-empty">Data potongan BPJS tidak ditemukan untuk periode ini.</div>
                    </td>
                </tr>
            @endforelse
        </tbody>
