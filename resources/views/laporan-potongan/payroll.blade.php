    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th>NIK</th>
                <th>Nama Pegawai</th>
                <th style="text-align:right;">Total Diterima / Transfer</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($items as $item)
                <tr>
                    ...
                    <td style="text-align:right; font-weight:600;">Rp {{ number_format($item['total'] ?? 0, 0, ',', '.') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="4">
                        <div class="table-empty">Data payroll tidak ditemukan untuk periode ini.</div>
                    </td>
                </tr>
            @endforelse
        </tbody>
